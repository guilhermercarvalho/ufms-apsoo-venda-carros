...
import br.ufms.apsoo.controllers.OrcamentoController;
 ...
 * @author alexlinux
 */
public class TelaRealizarOrcamento extends javax.swing.JFrame {
  ...
  // <editor-fold defaultstate="collapsed" desc="Generated
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Realizar Orçamento");
        ...
        caixaTextoCPFCliente.addActionListener(new java.awt.event.ActionListener() {
            ...
            private void caixaTextoCPFClienteActionPerformed(ActionEvent evt) {
            }
        });
        ...
        marcaBox.addComponentListener(new java.awt.event.ComponentAdapter() {
            ...
            private void marcaBoxComponentShown(ComponentEvent evt) {
            }
        });
        ...
        caixaTextoCodigoGerente.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                caixaTextoCodigoGerenteKeyPressed(evt);
            }

            private void caixaTextoCodigoGerenteKeyPressed(KeyEvent evt) {
            }
        });
  ...
  private void botaoConfirmarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_botaoConfirmarActionPerformed
    if (caixaTextoCPFCliente.getText().trim().equals("")) {
      ...
      this.orcamento = orcamentoController.finalizarOrcamento(this.valorEntrada, this.valorTotal, this.formaPagamento,
          this.numeroParcelas, this.funcionario.getCpf(), this.cliente.getCpf(), this.carro.getCodigo());
      if (this.orcamento == null) {
        JOptionPane.showMessageDialog(null, "Orçamento não realizada", null, WIDTH);
      } else {
        ConfirmacaoOrcamento telaConfirmacao = new ConfirmacaoOrcamento();
        telaConfirmacao.setOrcamento(orcamento);
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(TelaRealizarOrcamento.class.getName()).log(java.util.logging.Level.SEVERE, null,
          ex);
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        new TelaRealizarOrcamento().setVisible(true);
      }
    });
  }
