 ...
 */
package br.ufms.apsoo.views.Telas;
 ...
 * @author alexlinux
 */
public class ConfirmacaoOrcamento extends javax.swing.JFrame {
  ...
  // <editor-fold defaultstate="collapsed" desc="Generated
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Confirmacão De Orçamento");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        nomeCliente.setText("Nome Cliente: "+this.orcamento.getCliente().getNome());
        cpfCliente.setText("Cpf: "+this.orcamento.getCliente().getCpf());
        codigoCarro.setText("Código Do Carro: "+this.orcamento.getCarro().getCodigo().toString());
        marcaCarro.setText("Marca Do Carro: "+this.orcamento.getCarro().getMarca());
        modeloCarro.setText("Modelo Do Carro: "+ this.orcamento.getCarro().getModelo());
        valorCarro.setText("Valor Do Carro: " + this.orcamento.getCarro().getValor());
        formaPagamento.setText("Forma De Pagamento: "+this.orcamento.getFormaPagamento());
        if(this.orcamento.getNumParcelas() > 1){
             parcelas.setText("Numero De Vezes: - " + this.orcamento.getNumParcelas() + String
                     .format("\t Valor Das Parcelas: %.2f", (this.orcamento.getValorTotal()-this.orcamento.getValorEntrada()) / 
                             this.orcamento.getNumParcelas()));
        }
        else{
            parcelas.setText("Numero de Vezes: À VISTA");
        }
        valorTotal.setText("Valor Total: " + this.orcamento.getValorTotal());
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(ConfirmacaoOrcamento.class.getName()).log(java.util.logging.Level.SEVERE,
          null, ex);
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        new ConfirmacaoOrcamento().setVisible(true);
      }
    });
  }
